...
//gauntlet stuff
#define MAX_GAUNTLET_TRAINERS 27
#define MAX_GAUNTLET_MAPS 10

struct GauntletInfo
{
    u16 trainerIds[MAX_GAUNTLET_TRAINERS];
    u16 mapIds[MAX_GAUNTLET_MAPS];
    u16 readyFlag;
    u16 numTrainers:5;
    u16 numHeals:2;
    u16 isBossGauntlet:1;
    u16 warpId:4;
};
...
enum
{
    GAUNTLET_ROUTE_102,
    GAUNTLET_ROUTE_104,
    GAUNTLET_RUSTBORO_GYM,
    GAUNTLET_ROUTE_116,
    GAUNTLET_DEWFORD_GYM,
    GAUNTLET_ROUTE_109,
    GAUNTLET_ROUTE_110_AND_103,
    GAUNTLET_MAUVILLE_GYM,
    GAUNTLET_ROUTE_117,
    GAUNTLET_ROUTE_111_AND_112,
    GAUNTLET_ROUTE_113,
    GAUNTLET_ROUTE_114_AND_115,
    GAUNTLET_MT_CHIMNEY_AND_JAGGED_PASS,
    GAUNTLET_LAVARIDGE_GYM,
    GAUNTLET_PETALBURG_GYM,
    GAUNTLET_ROUTE_118_AND_119,
    GAUNTLET_FORTREE_GYM,
    GAUNTLET_ROUTE_120_AND_121,
    GAUNTLET_MT_PYRE,
    GAUNTLET_MAGMA_HIDEOUT,
    GAUNTLET_AQUA_HIDEOUT,
    GAUNTLET_ROUTE_124,
    GAUNTLET_ROUTE_125,
    GAUNTLET_MOSSDEEP_GYM,
    GAUNTLET_SPACE_CENTER,
    GAUNTLET_ROUTE_127,
    GAUNTLET_ROUTE_128,
    GAUNTLET_SEAFLOOR_CAVERN,
    GAUNTLET_ROUTE_129_TO_131,
    GAUNTLET_SOOTOPOLIS_GYM,
    GAUNTLET_VICTORY_ROAD,
    GAUNTLET_AMOUNT,
};
enum
{
    GAUNTLET_WARP_NONE,
    GAUNTLET_WARP_RUSTBORO,
    GAUNTLET_WARP_DEWFORD,
    GAUNTLET_WARP_BEACH,
    GAUNTLET_WARP_MAUVILLE,
    GAUNTLET_WARP_LAVARIDGE,
    GAUNTLET_WARP_PETALBURG,
    GAUNTLET_WARP_FORTREE,
    GAUNTLET_WARP_MT_PYRE,
    GAUNTLET_WARP_MAGMA,
    GAUNTLET_WARP_AQUA,
    GAUNTLET_WARP_MOSSDEEP,
    GAUNTLET_WARP_SPACE_CENTER,
    GAUNTLET_WARP_SEAFLOOR_CAVERN,
    GAUNTLET_WARP_SOOTOPOLIS,
    GAUNTLET_WARP_VICTORY_ROAD,
    GAUNTLET_WARP_AMOUNT,
};
