...
extern const u8 gText_PkmnHealed_FldPsn[];
...
extern const u8 gText_ChallengesYes[];
extern const u8 gText_ChallengesNo[];
...
extern const u8 gText_ChallengeDetails[];
...
extern const u8 gText_LevelCapDetails[];
extern const u8 gText_PermaDeath[];
extern const u8 gText_PermaDeathDetails[];
extern const u8 gText_LimitedEncounters[];
extern const u8 gText_LimitedEncountersDetails[];
extern const u8 gText_SpeciesClause[];
extern const u8 gText_SpeciesClauseDetails[];
extern const u8 gText_NoBattleItems[];
extern const u8 gText_NoBattleItemsDetails[];
extern const u8 gText_ForceSetMode[];
extern const u8 gText_ForceSetModeDetails[];
extern const u8 gText_GrassStarter[];
extern const u8 gText_GrassStarterDetails[];
extern const u8 gText_WaterStarter[];
extern const u8 gText_WaterStarterDetails[];
extern const u8 gText_FireStarter[];
extern const u8 gText_FireStarterDetails[];
extern const u8 gText_XPMultiplier[];
extern const u8 gText_XPMultiplierDetails[];
extern const u8 gText_InfiniteCandy[];
extern const u8 gText_InfiniteCandyDetails[];
extern const u8 gText_Repellant[];
extern const u8 gText_RepellantDetails[];
extern const u8 gText_EscapeRope[];
extern const u8 gText_EscapeRopeDetails[];
extern const u8 gText_FieldMoves[];
extern const u8 gText_FieldMovesDetails[];
extern const u8 gText_GauntletMode[];
extern const u8 gText_GauntletModeDetails[];
extern const u8 gText_StarterAffectsRival[];
extern const u8 gText_StarterAffectsRivalDetails[];
extern const u8 gText_ChallengesConfirm[];
extern const u8 gText_Extreme[];
...
extern const u8 gText_Birch_WhatChallengesAwait[];
...
extern const u8 gText_EVTotalVar1[];
...
extern const u8 gText_OldSeaMap[];
...
extern const u8 gText_YouMightNeedThat[];
