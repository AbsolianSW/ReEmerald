...
#define FLAG_TEMP_HIDE_FOLLOWER      (TEMP_FLAGS_START + 0xE) 
...
#define FLAG_ROUTE109_NPC_TRADE_COMPLETED    0x96
...
#define FLAG_RECEIVED_VS_SEEKER              0xE9 
...
#define FLAG_PETALBURG_GAUNTLET_READY                               0x2D9 
...
#define FLAG_ITEM_MT_CHIMNEY_TM_REFLECT                             0x409 // previously leftover RS flag, now actually used
...
#define FLAG_ITEM_NEW_MAUVILLE_THUNDERBOLT                          0x433
...
#define FLAG_ITEM_MT_CHIMNEY_TM_LIGHT_SCREEN                        0x465 // previously leftover Ruby flag, now actually used
#define FLAG_ITEM_MARINE_CAVE_TM_THUNDER                            0x466 // previously leftover Ruby flag, now actually used
#define FLAG_ITEM_MIRAGE_TOWER_FLAMETHROWER                         0x467 // previously leftover Ruby flag, now actually used
#define FLAG_ITEM_TERRA_CAVE_TM_FIRE_BLAST                          0x468 // previously unused flag, now used
...
#define FLAG_SAFE_FOLLOWER_MOVEMENT             (SPECIAL_FLAGS_START + 0x3)
