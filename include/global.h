...
struct SaveBlockProfile
{
    ...
    /*0x560*/ struct ItemSlot bagPocket_Powerup[BAG_POWERUP_COUNT];
    /*0x560*/ struct ItemSlot bagPocket_Battle[BAG_BATTLE_COUNT];
    /*0x560*/ struct ItemSlot bagPocket_Misc[BAG_MISC_COUNT];
