...
extern const u8 gPokedexStatScreen_Tilemap[];
extern const u8 gPokedexEvoScreen_Tilemap[];
extern const u8 gPokedexMoveScreen_Tilemap[];
extern const u8 gPokedexScreenSelectBarMain_Tilemap[];
extern const u8 gPokedexScreenSelectBarMain_Tilemap2[];
extern const u8 gPokedexScreenSelectBarSubmenu_Tilemap[];
extern const u8 gPokedexScreenSelectBarSubmenu_Tilemap2[];
