...
const u32 gPokedexScreenSelectBarMain_Tilemap2[] = INCBIN_U32("graphics/pokedex/screen_select_bar_main2.bin.lz");
const u32 gPokedexScreenSelectBarSubmenu_Tilemap[] = INCBIN_U32("graphics/pokedex/screen_select_bar_submenu.bin.lz");
const u32 gPokedexScreenSelectBarSubmenu_Tilemap2[] = INCBIN_U32("graphics/pokedex/screen_select_bar_submenu2.bin.lz");
...
const u32 gPokedexStatScreen_Tilemap[] = INCBIN_U32("graphics/pokedex/stat_screen.bin.lz");
const u32 gPokedexEvoScreen_Tilemap[] = INCBIN_U32("graphics/pokedex/evo_screen.bin.lz");
const u32 gPokedexMoveScreen_Tilemap[] = INCBIN_U32("graphics/pokedex/move_screen.bin.lz");
