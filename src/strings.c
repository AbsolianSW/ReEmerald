...
const u8 gText_SootSack[] = _("Your ASH:\n{STR_VAR_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_YouMightNeedThat[] = _("But you might need that one!");
...
const u8 gText_EVTotalVar1[] = _("EVs: {STR_VAR_1}"); // Previously unused emtpy string
...
const u8 gText_FriendshipVar1[] = _("FRNDSHP: {STR_VAR_1}"); // Previously unused Event Text
...
const u8 gText_OldSeaMap[] = _("OLD SEA MAP");
...
const u8 gText_LukesEgg[] = _("LUKEs EGG");
const u8 gText_IkesEgg[] = _("IKEs EGG");
const u8 gText_KevsEgg[] = _("KEVs EGG");
const u8 gText_EnisEgg[] = _("ENIs EGG");
const u8 gText_SimsEgg[] = _("SIMs EGG");
...
const u8 gText_PkmnHealed_FldPsn[] = _("{STR_VAR_1} survived the poison...\p\n");
...
const u8 gText_ChallengeDetails[] = _("{A_BUTTON} DETAILS     {B_BUTTON} CONFIRM");
...
const u8 gText_LevelCapDetails[] = _("Caps Level to next boss fight");
const u8 gText_PermaDeath[] = _("PERMA-DEATH");
const u8 gText_PermaDeathDetails[] = _("Fainted Pokemon can't be revived");
const u8 gText_LimitedEncounters[] = _("LIM. ENCOUNTERS");
const u8 gText_LimitedEncountersDetails[] = _("Only catch 1st encounter per location");
const u8 gText_SpeciesClause[] = _("SPECIES CLAUSE");
const u8 gText_SpeciesClauseDetails[] = _("Dupes don't count for lim. encounters");
const u8 gText_NoBattleItems[] = _("NO BATTLE ITEMS");
const u8 gText_NoBattleItemsDetails[] = _("No items in battle except held items");
const u8 gText_ForceSetMode[] = _("FORCE SET MODE");
const u8 gText_ForceSetModeDetails[] = _("Battle style is always Set mode");
const u8 gText_GrassStarter[] = _("GRASS STARTER");
const u8 gText_GrassStarterDetails[] = _("GRASS STARTER");
const u8 gText_WaterStarter[] = _("WATER STARTER");
const u8 gText_WaterStarterDetails[] = _("GRASS STARTER");
const u8 gText_FireStarter[] = _("FIRE STARTER");
const u8 gText_FireStarterDetails[] = _("GRASS STARTER");
const u8 gText_XPMultiplier[] = _("XP MULTIPLIER");
const u8 gText_XPMultiplierDetails[] = _("Applied to all XP earned");
const u8 gText_InfiniteCandy[] = _("INFINITECANDY");
const u8 gText_InfiniteCandyDetails[] = _("Key item with RareCandy functionality");
const u8 gText_Repellant[] = _("REPELLANT");
const u8 gText_RepellantDetails[] = _("Key item with Repel functionality");
const u8 gText_EscapeRope[] = _("ESCAPE ROPE");
const u8 gText_EscapeRopeDetails[] = _("Key item with Escape Rope functionality");
const u8 gText_FieldMoves[] = _("FIELD MOVES");
const u8 gText_FieldMovesDetails[] = _("Key item with Repel functionality");
const u8 gText_GauntletMode[] = _("GAUNTLET MODE");
const u8 gText_GauntletModeDetails[] = _("Key item with Repel functionality");
const u8 gText_StarterAffectsRival[] = _("AFFECTS RIVAL");
const u8 gText_StarterAffectsRivalDetails[] = _("Key item with Repel functionality");
const u8 gText_ChallengesConfirm[] = _("WARNING: These settings can't\nbe changed later. Are you sure?");
const u8 gText_Extreme[] = _("EXTREME");
...
const u8 gText_ChallengesYes[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}YES");
const u8 gText_ChallengesNo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO");
...
const u8 gText_StatTotal[] = _("TOTAL: {STR_VAR_1}");
const u8 gText_CatchRate[] = _("CATCH RATE");
const u8 gText_Yields[] = _("YIELDS");
const u8 gText_EffortValues[] = _("EFF. VALUES");
const u8 gText_Abilities[] = _("ABILITIES");
const u8 gText_EvoFriendship[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with high frndshp");
const u8 gText_EvoFriendshipDay[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with high frndshp at day");
const u8 gText_EvoFriendshipNight[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with high frndshp at night");
const u8 gText_EvoLevel[] = _("{STR_VAR_3}: Level up {STR_VAR_1} to LVL{STR_VAR_2}");
const u8 gText_EvoItem[] = _("{STR_VAR_3}: Use {STR_VAR_2} on {STR_VAR_1}");
const u8 gText_EvoAtkGTDef[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with ATK>DEF");
const u8 gText_EvoAtkEQDef[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with ATK=DEF");
const u8 gText_EvoAtkLTDef[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with ATK<DEF");
const u8 gText_EvoLevelSilcoon[] = _("{STR_VAR_3}: Level up certain {STR_VAR_1} to LVL7");
const u8 gText_EvoLevelCascoon[] = _("{STR_VAR_3}: Level up certain {STR_VAR_1} to LVL7");
const u8 gText_EvoLevelNinjask[] = _("{STR_VAR_3}: Level up {STR_VAR_1} to LVL20");
const u8 gText_EvoLevelShedinja[] = _("{STR_VAR_3}: Level up {STR_VAR_1} to LVL20 with space");
const u8 gText_EvoLevelBeauty[] = _("{STR_VAR_3}: Level up {STR_VAR_1} with high beauty");
const u8 gText_EvoNone[] = _("{STR_VAR_3}: Base form");
const u8 gText_Breed[] = _("{STR_VAR_3}: Breed {STR_VAR_1}");
const u8 gText_BreedAzurill[] = _("{STR_VAR_3}: Breed {STR_VAR_1} holding a SEA INCENSE");
const u8 gText_BreedWynaut[] = _("{STR_VAR_3}: Breed {STR_VAR_1} holding a LAX INCENSE");
const u8 gText_MoveHeader[]  = _("TYPE    MOVE              POW  ACC  PP       METHOD");
const u8 gText_LevelVar1[] = _("LVL{STR_VAR_1}");
const u8 gText_TMVar1[] = _("TM{STR_VAR_1}");
const u8 gText_HMVar1[] = _("HM{STR_VAR_1}");
const u8 gText_Tutor[] = _("TUTOR");
const u8 gText_PreEvo[] = _("PRE-EVO");
