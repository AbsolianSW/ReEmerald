...
const u8 gText_ChallengeDetails[] = _("{A_BUTTON} DETAILS");
...
const u8 gText_CustomStarter[] = _("CUSTOM STARTER");
const u8 gText_CustomStarterDetails[] = _("National Dex Number. {DPAD_UPDOWN} to change");
