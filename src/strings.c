...
const u8 gText_Breed[] = _("Breed {STR_VAR_1}");
const u8 gText_BreedAzurill[] = _("Breed {STR_VAR_1} holding a SEA INCENSE");
const u8 gText_BreedWynaut[] = _("Breed {STR_VAR_1} holding a LAX INCENSE");
