...
void CreateContestMonFromParty(u8 partyIndex)
{
    ...
    gContestMons[gContestPlayerMonIndex].otId = gSaveBlock2Ptr->otData[GetMonData(&gPlayerParty[partyIndex], MON_DATA_OT_INDEX)].Id;
...
static u8 CreateContestantSprite(u16 species, u32 otId, u32 personality, u32 index)
{
    ...
    LoadCompressedPalette(GetMonSpritePalFromSpeciesAndPersonality(species, otId, personality, FALSE), OBJ_PLTT_ID(2), PLTT_SIZE_4BPP);
