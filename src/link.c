...
static void InitLocalLinkPlayer(void)
{
    gLocalLinkPlayer.trainerId = gSaveBlock1Ptr->playerTrainerId[0] | (gSaveBlock1Ptr->playerTrainerId[1] << 8) | (gSaveBlock1Ptr->playerTrainerId[2] << 16) | (gSaveBlock1Ptr->playerTrainerId[3] << 24);
    StringCopy(gLocalLinkPlayer.name, gSaveBlock1Ptr->playerName);
    gLocalLinkPlayer.gender = gSaveBlock1Ptr->playerGender;
