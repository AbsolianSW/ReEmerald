...
void CreateBattleTowerMon(struct Pokemon *mon, struct BattleTowerPokemon *src)
{
    ...
    SetMonData(mon, MON_DATA_NATURE, &src->nature);
    MonRestorePP(mon);
    CalculateMonStats(mon);
}
...
u8 GiveMonToPlayer(struct Pokemon *mon)
{
    ...
    if (i >= PARTY_SIZE)
    {
        ...
        {
            CopyMon(&gEnemyParty[2], &gPlayerParty[gSpecialVar_0x8004], sizeof(*mon));
            CopyMon(&gPlayerParty[gSpecialVar_0x8004], mon, sizeof(*mon));
            CopyMon(mon, &gEnemyParty[2], sizeof(*mon));
        }
...
void CopyPlayerPartyMonToBattleData(u8 battlerId, u8 partyIndex)
{
    ...
    gBattleMons[battlerId].nature = GetMonData(&gPlayerParty[partyIndex], MON_DATA_NATURE, NULL);
