...
static const struct GFRomHeader sGFRomHeader = {
    ...
    .flagsOffset = offsetof(struct SaveBlockProfile, flags),
    .varsOffset = offsetof(struct SaveBlockProfile, vars),
    .pokedexOffset = offsetof(struct SaveBlockProfile, pokedex),
    .seen1Offset = offsetof(struct SaveBlockProfile, seen1),
    .seen2Offset = offsetof(struct SaveBlockProfile, seen2),
    ...
    .unk16 = 8,
    .unk17 = 12,
    .saveBlock2Size = sizeof(struct SaveBlockGeneral),
    .saveBlock1Size = sizeof(struct SaveBlockProfile),
    .partyCountOffset = offsetof(struct SaveBlockProfile, playerPartyCount),
    .partyOffset = offsetof(struct SaveBlockProfile, playerParty),
    .warpFlagsOffset = offsetof(struct SaveBlockProfile, specialSaveWarpFlags),
    .trainerIdOffset = offsetof(struct SaveBlockProfile, playerTrainerId),
    .playerNameOffset = offsetof(struct SaveBlockProfile, playerName),
    .playerGenderOffset = offsetof(struct SaveBlockProfile, playerGender),
    .frontierStatusOffset = offsetof(struct SaveBlockProfile, frontier.challengeStatus),
    .frontierStatusOffset2 = offsetof(struct SaveBlockProfile, frontier.challengeStatus),
    .unk18 = 0x00000000,
    ...
    .pcItemsOffset = offsetof(struct SaveBlockProfile, pcItems),
    .giftRibbonsOffset = offsetof(struct SaveBlockProfile, giftRibbons),
    .enigmaBerryOffset = offsetof(struct SaveBlockProfile, enigmaBerry),
