...
{
    const struct CompressedSpritePalette *spritePalette = GetMonSpritePalStructFromOtIdPersonality(species, otId, personality, FALSE);
...
static void ForFieldEffect(void) {
...
bool8 FldEff_FieldMoveShowMonInit(void)
{
    ...
    gFieldEffectArguments[1] = gSaveBlock2Ptr->otData[GetMonData(pokemon, MON_DATA_OT_INDEX)].Id;
