...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ONE_ISLAND] = {MAP_GROUP(ISLAND1_MAIN), MAP_NUM(ISLAND1_MAIN), HEAL_LOCATION_ISLAND1_MAIN},
    [MAPSEC_TWO_ISLAND] = {MAP_GROUP(ISLAND2_MAIN), MAP_NUM(ISLAND2_MAIN), HEAL_LOCATION_ISLAND2_MAIN},
    [MAPSEC_THREE_ISLAND] = {MAP_GROUP(ISLAND3_MAIN), MAP_NUM(ISLAND3_MAIN), HEAL_LOCATION_ISLAND3_MAIN},
    [MAPSEC_FOUR_ISLAND] = {MAP_GROUP(ISLAND4_MAIN), MAP_NUM(ISLAND4_MAIN), HEAL_LOCATION_ISLAND4_MAIN},
    [MAPSEC_FIVE_ISLAND] = {MAP_GROUP(ISLAND5_MAIN), MAP_NUM(ISLAND5_MAIN), HEAL_LOCATION_ISLAND5_MAIN},
    [MAPSEC_SIX_ISLAND] = {MAP_GROUP(ISLAND6_MAIN), MAP_NUM(ISLAND6_MAIN), HEAL_LOCATION_ISLAND6_MAIN},
    [MAPSEC_SEVEN_ISLAND] = {MAP_GROUP(ISLAND7_MAIN), MAP_NUM(ISLAND7_MAIN), HEAL_LOCATION_ISLAND7_MAIN}
};
...
static void CreateFlyDestIcons(void)
{
    ...
    switch(gMapHeader.region)
    {
        ...
        case REGION_SEVII67:
            ...
            mapSecEnd = MAPSEC_SIX_ISLAND;//for some reason the mapsecs for six and seven island are swapped
            break;
    }
