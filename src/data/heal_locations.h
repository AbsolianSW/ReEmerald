static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ISLAND1_MAIN - 1] = {MAP_GROUP(ISLAND1_MAIN), MAP_NUM(ISLAND1_MAIN), 14, 6},
    [HEAL_LOCATION_ISLAND2_MAIN - 1] = {MAP_GROUP(ISLAND2_MAIN), MAP_NUM(ISLAND2_MAIN), 20, 8},
    [HEAL_LOCATION_ISLAND3_MAIN - 1] = {MAP_GROUP(ISLAND3_MAIN), MAP_NUM(ISLAND3_MAIN), 14, 27},
    [HEAL_LOCATION_ISLAND4_MAIN - 1] = {MAP_GROUP(ISLAND4_MAIN), MAP_NUM(ISLAND4_MAIN), 18, 21},
    [HEAL_LOCATION_ISLAND5_MAIN - 1] = {MAP_GROUP(ISLAND5_MAIN), MAP_NUM(ISLAND5_MAIN), 17, 7},
    [HEAL_LOCATION_ISLAND6_MAIN - 1] = {MAP_GROUP(ISLAND6_MAIN), MAP_NUM(ISLAND6_MAIN), 17, 7},
    [HEAL_LOCATION_ISLAND7_MAIN - 1] = {MAP_GROUP(ISLAND7_MAIN), MAP_NUM(ISLAND7_MAIN), 11, 4},
};
