static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ISLAND3_MAIN - 1] = {MAP_GROUP(ISLAND3_MAIN), MAP_NUM(ISLAND3_MAIN), 9, 7},
    [HEAL_LOCATION_ISLAND4_MAIN - 1] = {MAP_GROUP(ISLAND4_MAIN), MAP_NUM(ISLAND4_MAIN), 16, 14},
    [HEAL_LOCATION_ISLAND5_MAIN - 1] = {MAP_GROUP(ISLAND5_MAIN), MAP_NUM(ISLAND5_MAIN), 12, 12},
    [HEAL_LOCATION_ISLAND7_MAIN - 1] = {MAP_GROUP(ISLAND7_MAIN), MAP_NUM(ISLAND7_MAIN), 12, 10},
};
