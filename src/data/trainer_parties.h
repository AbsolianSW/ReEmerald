...
static const struct TrainerMonItemCustomMoves sParty_Lukas[] = {
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKY_UPPERCUT,MOVE_BLAZE_KICK,MOVE_AERIAL_ACE,MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLY, MOVE_DRILL_PECK, MOVE_EXTREME_SPEED, MOVE_FACADE}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SILVER_WIND,MOVE_SKY_ATTACK,MOVE_MEGAHORN,MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METEOR_MASH,MOVE_CRUNCH,MOVE_SWORDS_DANCE,MOVE_STOCKPILE}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STRENGTH,MOVE_ROCK_SMASH,MOVE_SURF,MOVE_IRON_TAIL}
    },
    {
    .iv = 250,
    .lvl = 47,
    ...
    .moves = {MOVE_DRAGON_DANCE,MOVE_CRUNCH,MOVE_IRON_TAIL,MOVE_ROCK_SLIDE}
    },
};

static const struct TrainerMonItemCustomMoves sParty_Mike[] = {
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METRONOME,MOVE_DOUBLE_TEAM,MOVE_FOCUS_PUNCH,MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HORN_DRILL, MOVE_MEGAHORN, MOVE_SWORDS_DANCE, MOVE_ROLLOUT}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CURSE,MOVE_HYPER_BEAM,MOVE_TOXIC,MOVE_SLACK_OFF}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_SPOUT,MOVE_RAIN_DANCE,MOVE_BLIZZARD,MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DESTINY_BOND,MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_SPLASH}
    },
    {
    .iv = 250,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Owen[] = {
    ...
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE,MOVE_ICE_BEAM,MOVE_MUDDY_WATER,MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH,MOVE_EARTHQUAKE,MOVE_OUTRAGE,MOVE_FLAMETHROWER}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_VOLT_TACKLE,MOVE_CRUNCH,MOVE_IRON_TAIL,MOVE_CHARGE}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_PSYCHIC,MOVE_ICE_BEAM,MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_INGRAIN,MOVE_SLUDGE_BOMB,MOVE_ANCIENT_POWER,MOVE_GIGA_DRAIN}
    },
    {
    .iv = 250,
    .lvl = 47,
    ...
    .moves = {MOVE_VITAL_THROW,MOVE_BELLY_DRUM, MOVE_REST, MOVE_SLEEP_TALK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_SURF, MOVE_PSYBEAM, MOVE_PSYCH_UP, MOVE_DISABLE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .lvl = 39,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_UPROAR, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_HELPING_HAND, MOVE_SPARK, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 100,
    .lvl = 17,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_SWAGGER, MOVE_TORMENT, MOVE_SAND_ATTACK, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PROTECT, MOVE_DOUBLE_TEAM, MOVE_SUBSTITUTE, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_WISH, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_HYDRO_PUMP, MOVE_TAKE_DOWN}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_ABSOL,
    .heldItem = ITEM_BLACK_GLASSES,
    .moves = {MOVE_CRUNCH, MOVE_HYPER_BEAM, MOVE_SWORDS_DANCE, MOVE_IRON_TAIL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_SHADOW_BALL, MOVE_HYPER_BEAM, MOVE_WILL_O_WISP, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SHADOW_BALL, MOVE_SILVER_WIND, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_DOUBLE_TEAM, MOVE_DIG, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .moves = {MOVE_REST, MOVE_CURSE, MOVE_PROTECT, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .moves = {MOVE_EXPLOSION, MOVE_BLIZZARD, MOVE_HAIL, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WILL_O_WISP, MOVE_FLAMETHROWER, MOVE_HIDDEN_POWER, MOVE_CHARM}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .moves = {MOVE_BLIZZARD, MOVE_EARTHQUAKE, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .moves = {MOVE_BLIZZARD, MOVE_CALM_MIND, MOVE_HAIL, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_HAIL, MOVE_BLIZZARD, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_METEOR_MASH, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_BATON_PASS}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_REST, MOVE_OCTAZOOKA, MOVE_SLEEP_TALK}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_HYPER_BEAM, MOVE_IRON_TAIL, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_SALAMENCE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HARDEN, MOVE_MUD_SLAP, MOVE_HEADBUTT, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_HARDEN, MOVE_FURY_CUTTER, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ASTONISH, MOVE_CONSTRICT, MOVE_ABSORB, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_LOW_KICK, MOVE_ICE_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 16,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_CONFUSION, MOVE_REFLECT, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 16,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWAGGER, MOVE_EMBER, MOVE_DOUBLE_KICK, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 19,
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ARM_THRUST, MOVE_FAKE_OUT, MOVE_REVERSAL, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_WATER_GUN, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 255,
    .lvl = 20,
    ...
    .species = SPECIES_MAGNEMITE,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_SUPERSONIC, MOVE_SHOCK_WAVE, MOVE_RAIN_DANCE, MOVE_SONIC_BOOM}
    },
    {
    .iv = 255,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_SUNNY_DAY, MOVE_REST}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_AERIAL_ACE, MOVE_ENDEAVOR, MOVE_FACADE, MOVE_STEEL_WING}
    },
    {
    .iv = 255,
    .lvl = 27,
    ...
    .moves = {MOVE_CONFUSION, MOVE_FACADE, MOVE_STOMP, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .moves = {MOVE_CHARM, MOVE_LIGHT_SCREEN, MOVE_FACADE, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .moves = {MOVE_SLASH, MOVE_SWORDS_DANCE, MOVE_FACADE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 31,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_COUNTER, MOVE_YAWN, MOVE_FACADE, MOVE_REVERSAL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_SILVER_POWDER,
    .moves = {MOVE_SILVER_WIND, MOVE_WATER_PULSE, MOVE_GIGA_DRAIN, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_SAND_ATTACK, MOVE_TOXIC, MOVE_STEEL_WING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_XATU,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_SUNNY_DAY, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_ANCIENT_POWER, MOVE_CALM_MIND}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .moves = {MOVE_HYDRO_PUMP, MOVE_AERIAL_ACE, MOVE_RAIN_DANCE, MOVE_DRAGON_RAGE}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_REST, MOVE_PROTECT, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_BARRIER, MOVE_TOXIC, MOVE_SWAGGER}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_SLEEP_TALK, MOVE_ICE_BEAM, MOVE_REST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Victor[] = {
    {
    .iv = 25,
    .lvl = 100,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Victoria[] = {
    {
    .iv = 50,
    .lvl = 100,
    .species = SPECIES_BANETTE,
    .moves = {MOVE_SHADOW_BALL,MOVE_SCREECH,MOVE_NIGHT_SHADE,MOVE_GRUDGE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .lvl = 100,
    .species = SPECIES_SHEDINJA,
    .moves = {MOVE_RAZOR_WIND, MOVE_HYPER_BEAM, MOVE_SOLAR_BEAM, MOVE_DIG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ben[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_VOLT_TACKLE, MOVE_CHARGE, MOVE_PRESENT, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 150,
    .lvl = 17,
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_SLAM, MOVE_CHARGE, MOVE_WISH}
    }
};
...
static const struct TrainerMonEverything sParty_Wallace[] = {
    {
    .lvl = 58,
    ...
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_MEGAHORN, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_REVERSAL}
    },
    {
    .lvl = 58,
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HYPER_BEAM, MOVE_REST, MOVE_SNORE, MOVE_CURSE}
    },
    {
    .lvl = 59,
    .nature = NATURE_MILD,
    ...
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_STARF_BERRY,
    .moves = {MOVE_BLAZE_KICK, MOVE_THUNDER_PUNCH, MOVE_SKY_UPPERCUT, MOVE_SUNNY_DAY}
    },
    {
    .lvl = 59,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_HYDRO_PUMP, MOVE_ROAR}
    },
    {
    .lvl = 59,
    .nature = NATURE_ADAMANT,
    ...
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RECOVER, MOVE_REFRESH, MOVE_DIVE, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_SKY_ATTACK, MOVE_SAFEGUARD, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 150,
    .lvl = 47,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_ASSIST, MOVE_CHARM, MOVE_COVET}
    },
    {
    .iv = 150,
    .lvl = 47,
    .heldItem = ITEM_SITRUS_BERRY,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_PROTECT, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_INGRAIN}
    },
    {
    .iv = 150,
    .lvl = 47,
    .heldItem = ITEM_BRIGHT_POWDER,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_METEOR_MASH, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute103Mudkip[] = {
    ...
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_RIVAL_GRASS_STARTER,
    },
    {
    .iv = 0,
    .lvl = 3,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute103Treecko[] = {
    ...
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_RIVAL_FIRE_STARTER,
    },
    {
    .iv = 0,
    .lvl = 3,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute103Torchic[] = {
    ...
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_RIVAL_WATER_STARTER,
    },
    {
    .iv = 0,
    .lvl = 3,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    .lvl = 36,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWAGGER, MOVE_CRUNCH, MOVE_SCARY_FACE, MOVE_SUNNY_DAY},
    .species = SPECIES_MIGHTYENA,
    },
    {
    .iv = 255,
    .lvl = 37,
    .heldItem = ITEM_SALAC_BERRY,
    .moves = {MOVE_CURSE, MOVE_SLUDGE_BOMB, MOVE_FLY, MOVE_CONFUSE_RAY},
    .species = SPECIES_CROBAT,
    },
    {
    .iv = 255,
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivi[] = {
    ...
    .lvl = 100,
    .species = SPECIES_MUK,
    .moves = {MOVE_SLUDGE_BOMB,MOVE_DIG,MOVE_EXPLOSION, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 23,
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_FLAMETHROWER, MOVE_CURSE, MOVE_BODY_SLAM, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 23,
    .species = SPECIES_COMBUSKEN,
    .moves = {MOVE_BULK_UP, MOVE_SAND_ATTACK, MOVE_DOUBLE_KICK, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_HOWL, MOVE_ROAR}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_CHINCHOU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_SPARK, MOVE_CONFUSE_RAY, MOVE_FLAIL}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Amara[] = {
    {
    .iv = 0,
    .lvl = 55,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Maria_Sevii[] = {
    {
    .iv = 0,
    .lvl = 57,
    .species = SPECIES_KINGDRA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Abigail_Sevii[] = {
    {
    .iv = 0,
    .lvl = 55,
    .species = SPECIES_GOLDUCK,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Garrett[] = {
    {
    .iv = 0,
    .lvl = 55,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tommy_Sevii[] = {
    {
    .iv = 0,
    .lvl = 52,
    .species = SPECIES_SEAKING,
...
static const struct TrainerMonItemDefaultMoves sParty_Sharon_Sevii[] = {
    {
    .iv = 0,
    .lvl = 57,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMonItemDefaultMoves sParty_Tanya_Sevii[] = {
    {
    .iv = 0,
    .lvl = 55,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMonItemDefaultMoves sParty_Shea[] = {
    {
    .iv = 0,
    .lvl = 57,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMonItemDefaultMoves sParty_Hugh_Sevii[] = {
    {
    .iv = 0,
    .lvl = 57,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bryce[] = {
    {
    .iv = 0,
    .lvl = 55,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Claire[] = {
    {
    .iv = 0,
    .lvl = 53,
...
static const struct TrainerMonItemDefaultMoves sParty_Mik_And_Kia[] = {
    {
    .iv = 0,
    .lvl = 57,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_1[] = {
     {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_SUNNY_DAY, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 250,
    .lvl = 60,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STOCKPILE, MOVE_SPIT_UP, MOVE_SWALLOW, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 250,
    .lvl = 60,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Beth_Sevii[] = {
    {
    .iv = 0,
    .lvl = 55,
    .species = SPECIES_GLOOM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jocelyn_Sevii[] = {
    {
    .iv = 0,
    .lvl = 57,
    .species = SPECIES_HITMONCHAN,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_3[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_HOUNDOOM,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_4[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_HOUNDOOM,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_5[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_6[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_7[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonEverything sParty_Tabitha_Island1[] = {
    {
    .lvl = 65,
    ...
    .species = SPECIES_WEEZING,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MEMENTO, MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_SMOKESCREEN}
    },
    {
    .lvl = 65,
    .nature = NATURE_HASTY,
    .ability = 0,
    .iv = {30,31,31,31,30,31},
    .ev = {4,0,0,252,252,0},
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SUNNY_DAY, MOVE_OVERHEAT, MOVE_HIDDEN_POWER, MOVE_EXTREME_SPEED}
    },
    {
    .lvl = 65,
    .nature = NATURE_RELAXED,
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_REST, MOVE_HIDDEN_POWER, MOVE_LIGHT_SCREEN}
    },
    {
    .lvl = 65,
    .nature = NATURE_SASSY,
    ...
    .moves = {MOVE_FIRE_BLAST, MOVE_MAGNITUDE, MOVE_PROTECT, MOVE_ERUPTION}
    },
    {
    .lvl = 65,
    .nature = NATURE_ADAMANT,
    ...
    .species = SPECIES_SANDSLASH,
    .heldItem = ITEM_SCOPE_LENS,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_AERIAL_ACE, MOVE_HIDDEN_POWER}
    },
    ...
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_TAIL_GLOW, MOVE_FIRE_BLAST, MOVE_OUTRAGE, MOVE_HIDDEN_POWER}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_8[] = {
     {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_HOUNDOOM,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_9[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_10[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt_Mt_Ember_11[] = {
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_FLAREON,
...
static const struct TrainerMonEverything sParty_Courtney_Island1[] = {
    {
    .lvl = 65,
    .nature = NATURE_HASTY,
    .ability = 0,
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_HIDDEN_POWER, MOVE_SHADOW_BALL}
    },
    {
    .lvl = 65,
    .nature = NATURE_TIMID,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_BRICK_BREAK, MOVE_STRENGTH}
    },
    {
    .lvl = 68,
    .nature = NATURE_HASTY,
    ...
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_SCOPE_LENS,
    .moves = {MOVE_REST, MOVE_ROCK_BLAST, MOVE_SWORDS_DANCE, MOVE_SUBSTITUTE}
    },
...
static const struct TrainerMonEverything sParty_Shelly_Island2[] = {
    {
    .lvl = 66,
    .nature = NATURE_CALM,
    .ability = 0,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_SPIKES, MOVE_DESTINY_BOND, MOVE_SELF_DESTRUCT, MOVE_HYDRO_PUMP}
    },
    {
    .lvl = 66,
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_CRUNCH, MOVE_SCARY_FACE, MOVE_ROAR, MOVE_SAND_ATTACK}
    },
    {
    .lvl = 66,
    .nature = NATURE_BRAVE,
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_SHARP_BEAK,
    .moves = {MOVE_DRAGON_DANCE, MOVE_BOUNCE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE}
    },
    {
    .lvl = 66,
    .nature = NATURE_JOLLY,
    ...
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_BITE, MOVE_METAL_CLAW, MOVE_SLASH, MOVE_BEAT_UP}
    },
    {
    .lvl = 68,
    .nature = NATURE_CALM,
    ...
    .species = SPECIES_GOREBYSS,
    .heldItem = ITEM_SALAC_BERRY,
    .moves = {MOVE_BATON_PASS, MOVE_AMNESIA, MOVE_AGILITY, MOVE_HYDRO_PUMP}
    },
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_CALM_MIND, MOVE_MIRROR_COAT, MOVE_HYDRO_PUMP, MOVE_MIST}
    }
};