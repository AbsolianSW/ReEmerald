const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // ????????
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_OLDALE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_PETALBURG] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_RUSTBORO] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_SLATEPORT] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_MAUVILLE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_VERDANTURF] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_FALLARBOR] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_LAVARIDGE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_FORTREE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_MOSSDEEP] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_SOOTOPOLIS] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PLACEHOLDER_DYNAMIC_SHOP_EVERGRANDE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
