...
static bool8 MailReadBuildGraphics(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 12:
            ...
            gPlttBufferUnfaded[BG_PLTT_ID(0) + 10] = sBgColors[gSaveBlock1Ptr->playerGender][0];
            gPlttBufferFaded[BG_PLTT_ID(0) + 10] = sBgColors[gSaveBlock1Ptr->playerGender][0];
            gPlttBufferUnfaded[BG_PLTT_ID(0) + 11] = sBgColors[gSaveBlock1Ptr->playerGender][1];
            gPlttBufferFaded[BG_PLTT_ID(0) + 11] = sBgColors[gSaveBlock1Ptr->playerGender][1];
            break;
        case 13:
