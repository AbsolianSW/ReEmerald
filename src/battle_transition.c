...
static bool8 Mugshot_SetGfx(struct Task *task)
{
    ...
    LoadPalette(sPlayerMugshotsPals[gSaveBlock1Ptr->playerGender], BG_PLTT_ID(15) + 10, PLTT_SIZEOF(6));
...
static void Mugshots_CreateTrainerPics(struct Task *task)
{
    ...
    task->tPlayerSpriteId = CreateTrainerSprite(PlayerGenderToFrontTrainerPicId(gSaveBlock1Ptr->playerGender),
                                                DISPLAY_WIDTH + 32,
                                                106,
                                                0, gDecompressionBuffer);
