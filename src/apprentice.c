...
static void ShiftSavedApprentices(void)
{
    ...
    {
        if (GetTrainerId(gSaveBlock1Ptr->apprentices[i].playerId) == GetTrainerId(gSaveBlock1Ptr->playerTrainerId)
...
static void SaveApprentice(void)
{
    ...
    for (i = 0; i < TRAINER_ID_LENGTH; i++)
        gSaveBlock1Ptr->apprentices[0].playerId[i] = gSaveBlock1Ptr->playerTrainerId[i];

    StringCopy(gSaveBlock1Ptr->apprentices[0].playerName, gSaveBlock1Ptr->playerName);
