...
static void SafariHandleDrawTrainerPic(void)
{
    DecompressTrainerBackPic(gSaveBlock1Ptr->playerGender, gActiveBattler);
    SetMultiuseSpriteTemplateToTrainerBack(gSaveBlock1Ptr->playerGender, GetBattlerPosition(gActiveBattler));
    gBattlerSpriteIds[gActiveBattler] = CreateSprite(
      &gMultiuseSpriteTemplate,
      80,
      (8 - gTrainerBackPicCoords[gSaveBlock1Ptr->playerGender].size) * 4 + 80,
      30);
